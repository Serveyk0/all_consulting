...
import "./temporary_residence.sass";
...
export const TemporaryResidence: React.FC = ( props: any ): JSX.Element =>  
{
    show();
    ...
    return (
        <div className="temporary_residence">
            {//@ts-ignore
            <Helmet
            ...
            base={{"target": "_blank", "href": "/temporary_residence"}}
            meta={[
