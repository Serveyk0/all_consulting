...
import "./liquidation_of_a_legal_entity.sass";
...
export const LiquidationOfALegalEntity: React.FC = ( props: any ): JSX.Element =>  
{
    show();
    ...
    return (
        <div className="liquidation_of_a_legal_entity">
            {//@ts-ignore
            <Helmet
            ...
            base={{"target": "_blank", "href": "/liquidation_of_a_legal_entity"}}
            meta={[
